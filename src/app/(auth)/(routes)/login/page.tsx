...
const Login = () => {
  ...
  return (
    <section className=" w-full h-[100vh]  flex bg-white dark:bg-gray-950 items-center justify-center flex-col">
      <div className="flex flex-col  w-full justify-center">
        <span className="text-center dark:text-white" > <a className="" href="https://t.me/minimatchbot" target="_blank" rel="noopener noreferrer"> @minimatch</a> telegram botiga kiring va 1 daqiqalik kodingizni oling.</span>
        <form
